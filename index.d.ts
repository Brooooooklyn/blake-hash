...
export declare function blake2b(input: string | Buffer): Buffer
export declare function blake2bp(input: string | Buffer): Buffer
export declare function blake2s(input: string | Buffer): Buffer
export declare function blake2sp(input: string | Buffer): Buffer
export declare function blake3(input: string | Buffer): Buffer
export declare function blake3UrlSafeBase64(input: string | Buffer): string
